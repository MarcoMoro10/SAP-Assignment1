...
- **To release a reservation**
  ...
  - it is triggered when a scheduled/assigned delivery is **cancelled** by the sender
...
- **Policies**
  ...
  - **Whenever a delivery is cancelled (by sender), then release the drone reservation**
- **Domain Events**
